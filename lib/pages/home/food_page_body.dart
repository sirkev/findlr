...
import 'package:findlr/widgets/big_text.dart';
...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  double _height = Dimensions.pageViewerContainer;
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            BigText(text: "Nutrutious fruit meal in Juja"),
                            SizedBox(
                              height: Dimensions.height10,
                            ),
                            SmallText(text: "great meals, affordable prices"),
                            SizedBox(
                              height: Dimensions.height10,
                            ),
                            Row(
...
//called by slider container at the top
  Widget _buildPageItem(int index) {
    Matrix4 matrix = new Matrix4.identity();

    if (index == _currentPageValue.floor()) {
      //get scaling and based on scaling change position
    ...
    return Transform(
      ...
      child: Stack(
        children: [
          Container(
            height: Dimensions.pageViewerContainer,
            margin: EdgeInsets.only(
          ...
          Align(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: AppColumn(text: "Salma Fried Chicken",),
              ),
            ),
          ),
        ],
